...
prenons une toile avec 10 membres référents et xpercent=0.8. Et bien la qualité d'un membre dans une telle toile est le rapport entre le nombre de membres référents qu'il permet de joindre en moins de 5 pas et le rapport est de 8. Donc si un membre Bob permet de joindre 4 référents il aura une qualité de 0.5.
